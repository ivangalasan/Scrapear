...
- `chronicles.ui.web`: aplicación Flask ligera que reutiliza `CampaignEngine`
  para ofrecer un panel web con el estado de la campaña y la acción de avanzar
  el día.
...
Esta base se puede ampliar con interfaces más ricas (mapas interactivos,
editores internos) manteniendo `CampaignEngine` como capa de dominio común.
